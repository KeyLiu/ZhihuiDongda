...
- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame rectColor:(UIColor *)rectColor {
    ...
    if (self) {
        ...
        _cornerLayer.strokeColor = [UIColor colorWithRed:103/255.0 green:182/255.0 blue:236/266.0 alpha:1].CGColor;
        ...
        _lineLayer.fillColor = [UIColor colorWithRed:103/255.0 green:182/255.0 blue:236/266.0 alpha:1].CGColor;
        ...
        _lineAnimation.autoreverses = NO;
        ...
        _torchSwithButton.imageEdgeInsets = UIEdgeInsetsMake(.0, _torchSwithButton.titleLabel.bounds.size.width / 2+ 10, _torchSwithButton.titleLabel.frame.size.height + 5.0, - _torchSwithButton.titleLabel.bounds.size.width / 2);
        ...
        _tipsLabel.text = @"将取景框对准二维码/条形码,即可自动扫描";
